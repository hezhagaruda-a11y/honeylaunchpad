...
/*
  ===================================================================
  PROTOCOL TRAFFIC – THE LIVING NERVOUS SYSTEM OF HONEY LAUNCHPAD
  ===================================================================
  Real-time monitoring of Spark DEX swaps and IDO activity.
  Fully synced with latest deployed contracts (May 31, 2026).
*/

const FACTORY_ADDRESS = "0xC54734432183aE0A2AD8d4Db4775148e8714F0d4";
const SPARK_DEX_POOL = "0x85a3F23A4463922F109AE2656B0e563E7CEC6564";
...
sparkPool.on("Swap", (sender, amount0In, amount1In, amount0Out, amount1Out, to) => {
  ...
  const amount = amount0Out > 0 
    ? ethers.formatUnits(amount0Out, 18) 
    : ethers.formatUnits(amount1Out, 18);
