...
window.loadLeaderboard = async function loadLeaderboard() {
  ...
  tbody.innerHTML = `<tr><td colspan="5" style="text-align:center; padding:60px; color:#888;">Verifying access...</td></tr>`;
  ...
  try {
    ...
    if (tier === 0) {
      tbody.innerHTML = `<tr><td colspan="5" style="text-align:center; padding:60px; color:#f44336;">This page is Investor NFT gated.<br>You need at least one Investor NFT to view the leaderboard.</td></tr>`;
      return;
    }
    ...
    console.error(e);
    tbody.innerHTML = `<tr><td colspan="5" style="text-align:center; color:red; padding:60px;">Error loading leaderboard.<br>Please connect wallet and try again.</td></tr>`;
  }
};
