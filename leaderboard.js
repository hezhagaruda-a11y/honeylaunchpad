...
window.loadLeaderboard = async function loadLeaderboard() {
  ...
  tbody.innerHTML = `<tr><td colspan="3" style="text-align:center; padding:60px;">Loading leaderboard...</td></tr>`;
  ...
  try {
    ...
    if (rows.length === 0) {
      tbody.innerHTML = `<tr><td colspan="3" style="text-align:center; padding:60px; color:#888;">No data yet. Be one of the first players!</td></tr>`;
    }

  } catch (e) {
    console.error("Leaderboard error:", e);
    tbody.innerHTML = `<tr><td colspan="3" style="text-align:center; color:red; padding:60px;">Error loading leaderboard.<br>Please try again later.</td></tr>`;
  }
};
